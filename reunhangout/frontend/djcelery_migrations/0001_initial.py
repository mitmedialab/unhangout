# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2016-08-09 16:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('RECEIVED', 'RECEIVED'), ('REVOKED', 'REVOKED'), ('RETRY', 'RETRY'), ('SUCCESS', 'SUCCESS'), ('FAILURE', 'FAILURE'), ('STARTED', 'STARTED'), ('PENDING', 'PENDING')], default='PENDING', max_length=50, verbose_name='state')),
